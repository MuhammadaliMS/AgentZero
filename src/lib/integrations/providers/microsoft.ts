...
export class MicrosoftAuthService extends BaseAuthService {
  readonly integrationKey = 'microsoft_365'

  getDefaultScopes(): string[] {
    return ['Mail.Read', 'Mail.Send', 'Calendars.Read', 'User.Read', 'offline_access']
  }
