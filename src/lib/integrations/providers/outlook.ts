...
/**
 * Microsoft Outlook (email) OAuth provider.
 *
 ...
 *   Microsoft Graph → Delegated → Mail.Read, Mail.Send, User.Read
 */
export class OutlookAuthService extends BaseAuthService {
  readonly integrationKey = 'outlook'

  getDefaultScopes(): string[] {
    return ['Mail.Read', 'Mail.Send', 'User.Read', 'offline_access']
  }
